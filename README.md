...
En este ejercicio, se puso el practica el uso de hot observable  BehaviorSubject  para emitir al badge del carrito la información; cada vez que el usuario le da click al "Add to Cart" se incrementaria un items.
